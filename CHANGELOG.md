...
### Fixed
- Corrected the framework comparison example to use `#[InputFile]` for file upload parameters
- Restored missing changelog entries for `1.0.0` and `0.3.0`
...
### Added
- Support direct nested array input for object parameters, such as `author => ['name' => 'John']`
...
[1.1.1]: https://github.com/ray-di/Ray.InputQuery/releases/tag/v1.1.1
